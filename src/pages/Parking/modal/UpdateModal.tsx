...
import { ParkingLotResult, putParkingLotCar } from "../../../redux/ParkingLotReducer/ParkingLotReducer";
...
export const UpdateModal = (props: any) => {
  ...
  const { openDad, parentCallback, error,userDad,parentCallbackAlert,parentCallbackMessageAlert   } = props;
  ...
  const frmUser = useFormik<ParkingLotResult>({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        const actionAsyncparking = putParkingLotCar (values);
                ...
                <div>
                  ...
                  {frmUser.touched.parkingLotImg && frmUser.errors.parkingLotImg && (
                   ...
                   {selectedleftImage == undefined ? (
                      <img
                        alt=""
                        className="mx-auto h-40 w-40 my-5"
                        src={userDad?.parkingLotImg}
                      />
                    ) : (
                      selectedleftImage && (
                        <img
