...
import LineChart from "../Dashboard/Admindashboard/ChartComponent";
...
const columns: readonly Column[] = [
  ...
  {
    id: "insuranceMoney",
    label: "Tiền bảo hiểm(Vnđ)",
    minWidth: 170,
    align: "center",
  },
  {
    id: "violationMoney",
    label: "Tiền vi phạm(Vnđ)",
    minWidth: 160,
    align: "center",
  },
  {
...
export default function Statistic() {
  ...
  const [rowsPerPageCar, setRowsPerPageCar] = useState(4);
  ...
  function createData(data: any, index: number) {
    ...
    let insuranceMoney = formatToVND(data.insuranceMoney);
    let violationMoney = formatToVND(data.violationMoney);
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Stack spacing={3}>
            <DesktopDatePicker
              ...
              onChange={(newValue) =>
                handleChangeStartDay(newValue == null ? date : newValue)
              }
              renderInput={(params) => (
                <TextField
                  size="small"
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Stack spacing={3}>
            <DesktopDatePicker
              ...
              inputFormat="DD/MM/YYYY"
              onChange={(newValue) =>
                handleChangeEndDay(newValue == null ? date : newValue)
              }
              renderInput={(params) => (
                <TextField
                  size="small"
      ...
      <Card className="m-5">
        <Box component="div" sx={{ width: "100%" }}>
          <Box component="div" sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              <Tab label="Hợp đồng" {...a11yProps(0)} />
              <Tab label="Xe" {...a11yProps(1)} />
          ...
          <TabPanel value={value} index={0}>
            ...
            <div className="mt-2">
              <div className="">
                <h2 className="uppercase text-xl text-[#2c2c2c] font-medium">Tổng doanh thu</h2>
                <ChartDay
                  total={formatToVND(totalUsingSum)}
                  data={[
                    {
                      name: "Tổng tiền ETC",
                      data: [
                    ...
                    },
                    {
                      name: "Tổng tiền xăng",
                      data: [
                        fuelMoneyUsingUsingSum
                      ],
                    },
                    {
                      name: "Tổng tiền quá giờ",
                      data: [
                        extraTimeMoneyUsingSum,
                      ],
                    },
                    {
                      name: "Tổng tiền quá Km",
                      data: [
                        extraKmMoneyUsingSum,
                      ],
                    },
                    {
                      name: "Tổng tiền bảo hiểm",
                      data: [
                        insuranceMoneySum,
                      ],
                    },
                    ...
                    {
                      name: "Tổng tiền thuê xe",
                      data: [
                        paymentAmountUsingSum,
                      ],
                    },
                  ]}
                />
                          ...
                          <>
                            <TableRow component="div" className="" style={{ height: '40px' }} >
                              ...
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1 " colSpan={1}>
                                {formatToVND(etcmoneyUsingSum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(fuelMoneyUsingUsingSum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(extraTimeMoneyUsingSum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(extraKmMoneyUsingSum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(insuranceMoneySum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(violationMoneySum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(paymentAmountUsingSum)}
                              </TableCell>
                              <TableCell component="div" align="center" className=" h-10 font-bold py-1" colSpan={1}>
                                {formatToVND(totalUsingSum)}
                              </TableCell>
                            </TableRow>
                            {((rowsPerPage > 0
          ...
          <TabPanel value={value} index={1}>
            ...
            <div className="mt-2">
              <div>
                <h2 className="uppercase text-xl text-[#2c2c2c] font-medium mb-2">Tổng doanh thu</h2>
                <PieChart data={[carRevenuesTotal, carExpensesTotal]} />
              </div>
              <div className="">
                <h2 className="uppercase text-xl text-[#2c2c2c] font-medium mb-2">Doanh thu chi tiết</h2>
                <Paper sx={{ overflow: "hidden" }} className="">
                    ...
                    <Table sx={{
                      ...
                      <TableBody component="div">
                        {loading == true ? (
                          dataLoad.map((row, index) => {
                            return (
                              <TableRow
                                ...
                                key={index}
                              >
                                {dataLoadRowCar.map((column, index) => {
                                  return (
                                    <TableCell component="div" key={index}>
                                      <Skeleton
                                        variant="rectangular"
                          ...
                          <>
                            <TableRow component="div" className="" style={{ height: '40px' }} >
                              <TableCell align="right" className="h-10 font-bold px-3 py-1" colSpan={2}>
                                <div className="">
                                  Tổng doanh thu
                                </div>
                              </TableCell>
          ...
          <TabPanel value={value} index={2}>
            <div className="  gap-2  flex font-sans font-bold uppercase ml-2 text-lg border-l-4 border-blue-400">
